...
public class StateAtaquePatrol : State
{
    ...
    public override void Awake()
    {
        ...
        patrol.condition = new ConditionDistGT(transform, GameObject.FindWithTag("Player").transform, 2.0f);
        patrol.target = GetComponent<StatePatrulha>();
